...
ssh ubuntu@rpi_4 'sudo apt-get purge -y edgecaffe-edgecaffeapp' || true
...
ssh ubuntu@rpi_2 'sudo apt-get purge -y edgecaffe-edgecaffeapp' || true
...
ssh ubuntu@rpi_1 'sudo apt-get purge -y edgecaffe-edgecaffeapp' || true
